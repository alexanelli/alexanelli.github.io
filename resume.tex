...
\href{mailto:atanelli17@gmail.com}{atanelli17@gmail.com} | 315.744.0035
}
...
\section{Awards}
\location{Hologen - UBHacking 2015:}
Best Hardware Hack\\
2\textsuperscript{nd} Place Overall\\
\location{Spinbot - UBHacking 2016:}
...
\runsubsection{Full Stack Software Engineering Intern}
\linebreak
\descript{Python-Django | Javascript | SQL-Postgres-SQLite | Git}
\location{Classavo | January 2017 - June 2017}
\vspace{\topsep} % Hacky fix for awkward extra vertical space
\begin{tightemize}
...
\linebreak
\descript{Java | Obect Oriented Programming}
\location{UB CSE115: Intro to Computer Science I | January 2017 - May 2017}
\begin{tightemize}
...
%\item implemented the site layout and front end design using html, css, and AngularJS
\end{tightemize}
\sectionsep
